      ...
      <main className="flex-1 w-full max-w-6xl mx-auto p-4 sm:p-8 flex flex-col">
        {!selectedCharacter ? (
          ...
          <section className="flex-1 flex flex-col animate-in fade-in duration-500">
            ...
            {work.characters.length > 0 && work.characters.every(char => failedUrls[`${work.baseUrl}${char.code}_${selectedGlobalSituation || work.defaultSituation}.webp?v=0`]) && (
          ...
          <section className="flex-1 flex flex-col animate-in fade-in duration-500">
            ...
            {work.situations.length > 0 && work.situations.every(sit => failedUrls[`${work.baseUrl}${selectedCharacter}_${sit.code}.webp?v=0`]) && (
              <div className="text-center py-24">
                <p className={`text-sm ${isDarkMode ? 'text-neutral-400' : 'text-neutral-500'}`}>
